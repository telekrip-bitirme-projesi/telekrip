...
public class AdapterAddUser extends BaseAdapter {
    TextView _tvUserName;
    CircleImageView _ivAvatar;
    private Context ctx;
    private List<User> listUser;

    public AdapterAddUser(Context ctx, List<User> listUser){
        this.ctx=ctx;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(myView==null){
            ...
            myView= ınflater.inflate(R.layout.user_add_listview_item,null);
        }
